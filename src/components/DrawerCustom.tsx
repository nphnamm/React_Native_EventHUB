...
const DrawerCustom = ({navigation}: any) => {
  ...
  console.log('name', user.name.split(' ')[user.name.split(' ').length -1])
  return (
          ...
          {user.photo ? (
            ...
            >
                <TextComponent
                  ...
                  text={
                    user.name ? user.name.split(' ')[user.name.split(' ').length -1].substring(0,1).toUpperCase() : ''
                  } 
                />
        ...
        <FlatList
          ...
          renderItem={({item,index})=>(
            <RowComponent
              ...
              onPress={
                item.key === 'SignOut' ? () => handleSignOut() : ()=>{console.log(item.key); navigation.closeDrawer();}
              }
